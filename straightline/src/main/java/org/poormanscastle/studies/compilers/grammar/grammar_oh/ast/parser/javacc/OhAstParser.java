...
import org.poormanscastle.studies.compilers.grammar.grammar_oh.ast.domain.ExpressionList;
...
import org.poormanscastle.studies.compilers.grammar.grammar_oh.ast.domain.StatementList;
...
{if ("" != null) return new TextExpression(CodePosition.createFromToken(valueToken), valueToken.image);}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x43280002,0x40080002,0x2000000,0x43280002,0x400000,0x40000,0x800000,0x20000,0x10000,0x8000,0x2000,0x1e00,0x1e00,0x180,0x180,0x60,0x60,0x78100010,0x78100000,};
   }
